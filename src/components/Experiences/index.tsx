                    ...
                    {Object.values(experienceData).map((experience: Experience) => (
                        <article key={experience.experience_id} className="flex flex-col items-start justify-between bg-gray-900 p-6 rounded-2xl border border-gray-600 cursor-pointer w-full hover:bg-gray-800" onClick={() => openModal(experience)} data-aos="fade-in">
                            ...
                            <div className="relative mt-4 flex items-center gap-x-4">
                                <Image width={40} height={40} src={experience.experience_company_avatar_sync} alt="" className="h-10 w-10 rounded-full bg-gray-50" />
                        ...
                        <div className="w-full sm:w-4/5 2xl:w-2/6 relative p-8 rounded-2xl border border-gray-600 bg-gray-900 max-h-full overflow-scroll" onClick={(e) => e.stopPropagation()}>
                            <div>
                                <div className="flex gap-x-4 items-center">
                                    <Image width={50} height={50} src={showExperience.experience_company_avatar_sync} alt="" className="h-12 w-12 rounded-full bg-black" />
